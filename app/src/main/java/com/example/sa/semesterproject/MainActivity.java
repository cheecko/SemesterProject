...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayout.getTabAt(2).setIcon(R.drawable.aboutme);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    Tab1Calendar tab1Calendar = new Tab1Calendar();
                    return tab1Calendar;
                case 1:
                    Tab2Hadith tab2Hadith = new Tab2Hadith();
                    return tab2Hadith;
                case 2:
                    Tab3AboutMe tab3AboutMe = new Tab3AboutMe();
                    return tab3AboutMe;
                default:
                    return null;
            }
